...
function RouteComponent() {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className='p-4'>
        <div className=' py-1 pb-3 flex flex-row items-center'>
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage className='flex flex-row gap-4'>
                ...
                <ul className="space-y-2">
                  ...
                  {teams?.map((team) => {
                    if (team.team.is_private) {
                      return (
                        <li key={team.id} className="flex items-center justify-between space-x-2 text-nowrap border border-secondary p-2 rounded-md">
