...
// Only need to import WorkspaceData, as it now aliases TeamDetails
...
/**
 * @description Hook for fetching all the necessary data for a given workspace view.
 * @param teamId - The ID of the workspace (team) to fetch.
 */
export const useWorkspaceDataQuery = (teamId: string | undefined) => {
  return useQuery<WorkspaceData | null, Error>({ // Use WorkspaceData (which is TeamDetails)
