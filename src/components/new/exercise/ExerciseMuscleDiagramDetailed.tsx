...
const ExerciseMuscleDiagram: React.FC<ExerciseMuscleDiagramProps> = ({ muscles }) => {
  ...
  return (
    <div className="group relative flex-shrink-0 flex flex-col gap-4 h-full justify-between items-center">
      {/* Front view - always visible */}
        <Model
          data={muscleData}
          styles={customStyles}
          key="anterior-model"
          style={{ width: "125px", height: "150px" }} // Same size as back
        />
      ...
      {/* Back view - visible on hover */}
        <Model
          ...
          type='posterior'
          key="posterior-model"
          style={{ width: "125px", height: "150px" }} // Same size as front
        />
    </div>
  );
};

export default ExerciseMuscleDiagram;